...
begin
  TAlphaColorRec(Result).R := 39;
  TAlphaColorRec(Result).G := 63;
  TAlphaColorRec(Result).B := 135;
...
begin
  //TAndroidHelper.Activity.getWindow.setNavigationBarColor( uFuncoes.NavigatorColor );
  ///TAndroidHelper.Activity.getWindow.setStatusBarColor ( TAlphaColorRec.Royalblue );
end;
...
begin
 ...
 // StatusBarSetColor( TAlphaColorRec.Royalblue);
end;
...
procedure TFrmLogin.Label10Click(Sender: TObject);
begin
  ActFoto.Execute;
end;
